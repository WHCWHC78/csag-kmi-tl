<div class="row">
    <div class="span8" style="text-align: center;">
        <iframe width="560" height="315" src="http://www.youtube.com/embed/1A2S2RsINvY" frameborder="0" allowfullscreen></iframe>
    </div>
    <div class="span4">
...
<div id="mainSlide" class="carousel slide">
    <div class="carousel-inner" style="text-align: center;">
        <div class="active item"><a href="http://kmi.tl/csaggroup" target="_blank"><img src="<?php echo base_url("resources/img/slide1.png"); ?>" width="940" height="350" /></a></div>
        <!--<div class="item"><a href="#" target="_blank"><img src="<?php echo base_url("resources/img/slide2.png"); ?>" width="940" height="350" /></a></div>
        <div class="item"><a href="#" target="_blank"><img src="<?php echo base_url("resources/img/slide3.png"); ?>" width="940" height="350" /></a></div>-->
    <!--</div>-->
...
<div class="modal hide fade" id="m_freedom">
...
<div class="modal hide fade" id="m_friends">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">×</button>
...
<div class="modal hide fade" id="m_features">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">×</button>
...
<div class="modal hide fade" id="m_fun">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">×</button>
