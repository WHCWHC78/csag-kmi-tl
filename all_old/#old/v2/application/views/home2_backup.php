...
<div id="mainSlide" class="carousel slide">
    <div class="carousel-inner" style="text-align: center;">
        <div class="active item" style="background-image: url('<?php echo base_url("resources/img/regis.png"); ?>'); height:350px;"><div style="padding-top: 140px;"><a class="btn btn-info btn-large" href="<?php echo base_url("regis"); ?>">สมัคร/ดูรายละเอียด</a></div></div>
