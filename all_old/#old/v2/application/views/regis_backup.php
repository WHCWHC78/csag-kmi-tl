                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align: left;">
                                        ...
                                        - การติดตั้งเว็บเซิร์ฟเวอร์ และฐานข้อมูล แบบกระบวนการ LAMP
                                    </td>
                                    <td>18 สิงหาคม 2555<br/>09.00 - 12.00</td>
                                    <td>Coming soon</td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">
                                    ...
                                    <td>18 สิงหาคม 2555<br/>13.00 - 16.00</td>
                                    <td>Coming soon</td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">
                                        ...
                                        - ระบบ IP Address, MAC Address, Subnet Mask
                                    </td>
                                    <td>19 สิงหาคม 2555<br/>09.00 - 12.00</td>
                                    <td>Coming soon</td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">
                                    ...
                                    <td>19 สิงหาคม 2555<br/>13.00 - 16.00</td>
                                    <td>Coming soon</td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">
                                        ...
                                        - การพัฒนาเว็บด้วยภาษา HTML5, CSS3, Javascript
                                        - การพัฒนาเว็บด้วยภาษา PHP เบื้องต้น
                                    </td>
                                    <td>25 สิงหาคม 2555<br/>09.00 - 12.00</td>
                                    <td>Coming soon</td>
                                </tr>
                                <tr>
                                    <td style="text-align: left;">
                                    ...
                                    <td>25 สิงหาคม 2555<br/>13.00 - 16.00</td>
                                    <td>Coming soon</td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="span5 property">
                            ...
                            <div>
                                <ol>
                                    ...
                                    <li>ตอบคำถามออนไลน์ในช่วงเวลาที่กำหนด (ตั้งแต่ตอนนี้ ถึง 24 สิงหาคม 2555)</li>
                                    <li>ทดสอบคัดเลือกที่สำนักบริการคอมพิวเตอร์</li>
    ...
    <?php echo (validation_errors() != "") ? '<div class="well">' . validation_errors() . '</div>' : ""; ?>
                        <fieldset>
                            ...
                            <div class="control-group<?php echo (form_error('age') != "") ? " error" : ""; ?>">
                                ...
                                <div class="controls">
                                    <input type="radio" id="age17" name="age" value="18" <?php echo set_checkbox('age', '17', TRUE); ?> /> 17
                                    <input type="radio" id="age18" name="age" value="19" <?php echo set_checkbox('age', '18'); ?> /> 18
                                    <input type="radio" id="age19" name="age" value="20" <?php echo set_checkbox('age', '19'); ?> /> 19
                                    <input type="radio" id="age20" name="age" value="21" <?php echo set_checkbox('age', '20'); ?> /> 20
                                </div>
                            </div>
