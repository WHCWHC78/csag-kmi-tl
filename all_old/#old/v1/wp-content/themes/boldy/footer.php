			...
			<div id="footerWidgetsInner">
				...
				<div id="copyright">
					<?php if (get_option('boldy_copyright') <> ""){
						...
						<div id="site5bottom">Theme brought to you by <a href="http://gk.site5.com/t/239">Site5.com | Experts in Web Hosting.</a></div> 
						<div id="site5bottom">Computer System Administrator Group @CSC KMITL</div>
*/ ?>
				</div>
				<!-- END COPYRIGHT -->						
				</div>
